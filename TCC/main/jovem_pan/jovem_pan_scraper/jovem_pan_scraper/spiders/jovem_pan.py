...
# scrapy runspider jovem_pan_scraper/jovem_pan_scraper/spiders/jovem_pan.py -o output.csv --set delimiter=";"
...
class JovemPanSpider(scrapy.Spider):
    ...
    df = pd.read_csv('/home/az/repo/news_scraping/TCC/main/jovem_pan/jovem_pan_politica.csv', sep=';')
    links = df['URL'].tolist()
    start_urls = links
    data_list = []
    ...
    def parse(self, response):
        ...
        print("\n")
        print("################################################################################################")
        print("response.xpath.root: \n", response.xpath("//div[1]/div[1]/div[1]/div[1]/div[1]/article[1]/div[3]/p"))
        print("\n")
        print("################################################################################################")

        teste_elements = response.xpath("//div[1]/div[1]/div[1]/div[1]/div[1]/article[1]/div[3]/p")
